...
**Agent-BlocksNet** — это мультиагентная система для автоматизированного урбанистического моделирования, пространственного и транспортного анализа, а также оптимизации городских сервисов. Проект построен на базе фреймворка [OpenCode](https://opencode.ai/) и использует библиотеку [blocksnet](https://github.com/iduprojects/blocksnet) для комплексных вычислений.
